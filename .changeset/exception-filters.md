...
- An error no filter handles goes to the built-in fallback, which logs it and answers as before: "An error occurred while executing the command.", or "Command not found!".
