 ...
 * what would be generated and fails when they differ, which is how CI catches a dependency added
 * without its notice. Versions are left out on purpose -- they change with every update, and the
